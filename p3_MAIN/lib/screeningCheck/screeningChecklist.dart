                ...
                child: RoundedButtons('Continue', 18.0, 50.0, 200.0,
                      ...
                      counter == 0) // if the user doesn't select any checkbox
                  {
                    ...
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (context) =>
                              CheckListPageTwo(counter: counter)),
                    );
                  }
                }),
              )
...
class CheckListPageTwo extends StatefulWidget {
  ...
  final int
      counter; // Counter for the screening checklist score from the first page
...
// The second screening checklist page of the FIU P3 App.
  ...
  final options2 = [
    // yes and no options for second question
    ButtonSetting(
        height: 50.0,
        width: 135,
        colorBackground: Colors.white,
            ...
            child: ListView(
              children: <Widget>[
                ...
                Container(
                  padding: EdgeInsets.only(
                      top:
                          30), // Position of both the first question box and the text within it on page.
                  alignment: Alignment.topCenter,
                  child: Container(
                    height: 130.0,
                    width: 315.0,
                ...
                Container(
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        ...
                        Container(child: buildNoButton(options1[1])),
                      ],
                    )),
                ...
                Container(
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        ...
                        Container(child: buildNoButton(options2[1])),
                      ],
                    )),
                ...
                Container(
                  padding: EdgeInsets.only(bottom: 53, top: 30),
                  alignment: Alignment.topCenter,
                  child: RoundedButtons('Submit', 18.0, 50.0, 200.0,
                      FIUNavyBlue, Colors.white, 25.0, () {
                    ...
                    if (((options1[0].value == false &&
                      ...
                      AlertDialog alert = AlertDialog(
                        ...
                        content: Text(
                            "You either have not answered any or only one of the questions above or you did not agree to the statement above. Answer both questions and agree to the statement above to submit your screening."),
                        actions: [cancelButton],
                      );
                          ...
                          0) // if the user had a score of more than zero, not authorized
                      {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => ResultsUNAUTHORIZED()),
                        );
                      } else // otherwise, authorized
                      {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => ResultsAUTHORIZED()),
                        );
                      }
                    }
                  }),
    ...
    return Container(
      ...
      child: RaisedButton(
        ...
        child: Container(
          ...
          child: Text(
            "$text",
            style: new TextStyle(fontSize: fontsize, fontFamily: "Be Vietnam"),
          ),
        ),
